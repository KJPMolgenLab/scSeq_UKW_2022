...
```{r set colors and filebase}
set.seed(42)

home="/files/scRNA_Qualitycheck/data/"
...
datadirs = list.dirs(home,recursive = T)
...
```{r}
save(seurat_integrated, file = "/files/scRNA_Qualitycheck/output/01_QC_scRNA_seurat_integrated.Rdata")
```
